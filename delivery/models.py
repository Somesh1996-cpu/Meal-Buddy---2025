...
class Restaurant(models.Model):
    ...
    picture = models.URLField(
        max_length=200, default='https://designshack.net/wp-content/uploads/Free-Simple-Restaurant-Logo-Template.jpg')
...
class Item(models.Model):
    ...
    picture = models.URLField(
        max_length=400, default='https://shorturl.at/AtK4L')
